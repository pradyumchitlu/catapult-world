...
-- OAuth apps for third-party developer integrations
...
CREATE INDEX idx_oauth_apps_owner_user_id ON oauth_apps(owner_user_id);
CREATE INDEX idx_oauth_apps_client_id ON oauth_apps(client_id);
CREATE INDEX idx_oauth_authorization_codes_app_id ON oauth_authorization_codes(app_id);
